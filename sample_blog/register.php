...
<body style="background:#c0c0c0">
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center min-vh-100">
            <div class="col-4 ">
                <div class="card">
                    <h4 class="feather-users text-center mt-3 text-primary">User Register</h4>
                    <hr>
                    <div class="card-body">
                        <?php
                        ...
                        <form action="" method="post">
                            <div class="form-group">
                                <label for="" class="feather-user text-primary">
                                    <i class="text-dark">Your name</i>
                                </label>
                            ...
                            <div class="form-group mb-0">
                                <label for="" class="feather-lock text-primary">
                                    <i class="text-dark">Confirm Password</i>
                                </label>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="login.php" class="btn btn-outline-primary" name="loginBtn">Login</a>
